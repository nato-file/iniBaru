...
cl = LINETCR.LINE()
cl.login(token="ElemZ6nzKePMbIgcDGH3.5hcU8I/+c6LAXfuIvU1giW.PwZdXRs2moVC6NMmZqpzjoynC/WrR7OrbcExlmTwIFY=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EleL7S5D22EHHcaYMVBf.s6yBVqcgAV2mWy3TWaT6xW.Gp5yYKr0uPr3keot3l2NtNZ+CQeqgpyCi91muylabNU=")
ki.loginResult()
        ...
        if op.type == 19:
                if op.param2 not in admin:
                    if op.param3 in admin and Bots:
                        ...
                        cl.sendText(op.param1, cl.getContact(op.param2).displayName + " Jangan Main Kick!\n(/*´･ω･*\)")
                else:
                    pass
