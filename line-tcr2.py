...
cl = LINETCR.LINE()
cl.login(token="ElarFu0xoYl5L9dY0Ea3.5hcU8I/+c6LAXfuIvU1giW.r/8uO5V2lnbo905cMAPwNlvgIfCn4uVZPbwelI0+6xw=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EliUhXTDvUW1JnTIskOf.s6yBVqcgAV2mWy3TWaT6xW.UX+T7xweEzMcCj+nByyHbfWZ16fN5c1kmM7o9jXltCA=")
ki.loginResult()
...
admin=["u308205dd6abcc4bec5da585db20ab076","ue470aef22fbf0ba95ac4552256ed4623","u4ba61bbd00866afd8cc18dedc00b7a5f"]
...
def bot(op):
    try:
        ...
        if op.type == 17:
                ...
                cb = Message()
                cb.to = op.param1
                cb.text = random.choice(KAC).getContact(op.param2).displayName + " Selamat Datang Guys di " + group.name + "\nJangan nakal disini! ok!" + "\n\nOwner => " + group.creator.displayName 
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                ki.sendText(msg.to,Amid)
                 ...
                 cl.sendText(msg.to,"[ArHar & ArQyu ID\nArHar ID\n" + mid + "\n\nArQyu ID\n" + Amid)
...
#-----------------------------------------------
                ...
                cl.sendText(msg.to,"Ini Ibu ArHar.👩")
