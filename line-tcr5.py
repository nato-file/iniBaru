...
cl = LINETCR.LINE()
cl.login(token="ElH49LF8DfcLl11Y7dR3.5hcU8I/+c6LAXfuIvU1giW.JRIv/AUw9/xF3CUTzJg30OxBIqh1b6N3m2PJQoQQ29Q=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="El0GIh7Wan0jcp56Wlkf.s6yBVqcgAV2mWy3TWaT6xW.80ryuoHOFgeRr6Y+O1QUHanrSHYNFYPeomWLu9ibEIo=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="ElFDJDkMDdPc3BhDHi11.Ajp65JTg/dUAmSiDizYq8q.0T7aTZRZVwN1luCEfr3DO4bapMjLqM0chjny29H2esg=")
kk.loginResult()
        ...
        #-------------Fungsi Creator Start-----------------#
                ...
                if msg.toType == 2:
                      ...
                      try:
                        ...
                        Creatorbot = "Error"
                      cl.sendText(msg.to, "My Creator : Corry")
                      cl.sendMessage(msg)
...
#-----------------------------------------
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"Good bye all :)")
                else:
