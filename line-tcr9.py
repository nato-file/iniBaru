...
cl = LINETCR.LINE()
cl.login(token="ElQ4kUmpNN9wT3HocUV3.5hcU8I/+c6LAXfuIvU1giW.KOzF72VcUNeqyFIS1VeXMoODhsJ4ytLvIg5nhK72YPw=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="ElSgN4viM9ODtVO30UAf.s6yBVqcgAV2mWy3TWaT6xW.+iMJY6K+QlcpYKja1Vns/r4mRBwcw6Ua60ZmvXrp+wI=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EloXqUvYEnWHykTgq4F1.Ajp65JTg/dUAmSiDizYq8q.3VKuDcyG4YY8ZirFnfl+fI0DafcLW63z3QPaFJLORuE=")
kk.loginResult()

ar = LINETCR.LINE()
ar.login(token="ElHGCWR6oMcaXg4sfS79.LyFwDPcKGZe367JjdZ6X6q.1kv49sPvkFGhCyA6TG4zgohbi0oUgmgKOus0Q0T08tw=")
ar.loginResult()

pi = LINETCR.LINE()
pi.login(token="ElOkXe4pbT3DhbJDHavd.nE7xZHvN/AW1eJQ9V/1qdq.wLDDL9ZikfLTLbGjwpn0kKRCKba/YGrgpVOObC+Vul8=")
pi.loginResult()
